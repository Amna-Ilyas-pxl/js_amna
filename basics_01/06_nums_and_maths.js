...
console.log(Math.floor(Math.random()*10 + 1));  //also be written like this
...
// math.floor will print numbers without decimal(for single digit)
// +1 will avoid zero
// +min will add minimum value to formula which is assigned as 10 above.. so the values will be above or equal to 10